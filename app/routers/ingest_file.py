...
from app.services.ingest_file_service import ingest_file
...
async def ingest(
    ...
    """Legacy file ingestion endpoint ported to the 3-tier stores."""
    ...
    supported_extensions = (".pdf", ".png", ".jpg", ".jpeg", ".mp4", ".mov", ".mp3", ".wav", ".m4a")
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix=ext, mode="wb") as handle:
